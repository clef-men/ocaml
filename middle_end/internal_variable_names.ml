...
let patomic_store_loc = "Patomic_store_loc"
...
let patomic_store_loc_arg = "Patomic_store_loc_arg"
...
let of_primitive : Lambda.primitive -> string = function
  ...
  | Patomic_store_loc -> patomic_store_loc
...
let of_primitive_arg : Lambda.primitive -> string = function
  ...
  | Patomic_store_loc -> patomic_store_loc_arg
