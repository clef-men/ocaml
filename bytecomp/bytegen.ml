...
let preserve_tailcall_for_prim = function
  ...
  | Patomic_exchange | Patomic_cas | Patomic_fetch_add | Patomic_load _ | Patomic_load_field _ | Patomic_store_field _
  | Pdls_get ->
      false
...
let comp_primitive stack_info p sz args =
  ...
  | Patomic_load_field fld -> Kgetatomicfield fld
  | Patomic_store_field fld -> Ksetatomicfield fld
